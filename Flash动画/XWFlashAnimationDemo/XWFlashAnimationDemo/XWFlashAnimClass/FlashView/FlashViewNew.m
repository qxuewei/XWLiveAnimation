...
-(instancetype) initWithFlashName:(NSString *)flashName andAnimDir:(NSString *)animDir{
    return [self initWithFlashName:flashName andAnimDir:animDir scaleMode:FlashViewScaleModeWidthFit designResolution:CGSizeMake(640, 1136) designScreenOrientation:FlashViewScreenOrientationVer currScreenOrientation:FlashViewScreenOrientationNone];
}
...
-(BOOL) reload:(NSString *)flashName andAnimDir:(NSString *)animDir{
    return [self reload:flashName andAnimDir:animDir scaleMode:FlashViewScaleModeWidthFit designResolution:CGSizeMake(640, 1136)];
}
