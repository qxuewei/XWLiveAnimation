...
@implementation XWOceanAnimView
- (instancetype)init {
    if (self = [super init]) {
...
- (void)setModel:(XWGiftModel *)model {
    ...
    _smallLeftStarAnimView.image = [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_start_2_z_14th"];
    ...
    _smallRightStarAnimView.image = [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_start_2_z_14th"];
    
    
    //左后海浪
    _leftBackAnimView.image = [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_wave_Back_L_14th"];
    ...
    //右后海浪
    _rightBackAnimView.image = [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_wave_Back_R_14th"];
    ...
    //海盗船
    _shipAnimView.image = [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_boat_14th"];
    ...
    //左海浪
    _leftImageView.image   = [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_wave_L_14th"];
    ...
    _leftStarAnimView.image = [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_start_2_z_14th"];
    
    
    //右海浪
    _rightImageView.image  = [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_wave_R_14th"];
    ...
    _rightStarAnimView.image = [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_start_2_z_14th"];
    
    
    //海浪-前左（上下浮动）
    _leftDownAnimView.frame = CGRectMake(0,SCREEN_HEIGHT, KLeftDownAnimViewWidth, KLeftDownAnimViewHight);
    _leftDownAnimView.image = [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_wave_Front_L_14th"];
    ...
    _rightDownAnimView.image = [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_wave_Front_R_14th"];
...
-(void)shiningStarAinmView{
    ...
    [UIView animateWithDuration:0.5 delay:0 options:UIViewAnimationOptionCurveEaseIn animations:^{
        ...
        NSArray *magesArray = [NSArray arrayWithObjects:
                               [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_shiningstar_1_14th"],
                               [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_shiningstar_2_14th"],nil];
...
-(void)startBlueboomAnimView{
    NSArray *magesArray = [NSArray arrayWithObjects:
                           [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_Blueboom_1"],
                           [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_Blueboom_2"],
                           [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_Blueboom_3"],
                           [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_Blueboom_4"],
                           [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_Blueboom_5"],
                           [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_Blueboom_6"],
                           [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_Blueboom_7"],
                           [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_Blueboom_8"],
                           [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_Blueboom_9"],
                           [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_Blueboom_10"],
                           [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_Blueboom_11"],
                           [[XWAnimationImageCache shareInstance] getImageWithName:@"ic_Blueboom_12"],nil];
